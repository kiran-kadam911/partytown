...
class __TwigTemplate_f82a79aba4421be07fa460d67af2fa9e extends Template
{
    private $source;
    private $macros = [];
...
<html";
  ...
  <head>
    ...
    ";
        // line 42
        $this->loadTemplate("@olivero/includes/preload.twig", "core/themes/olivero/templates/layout/html.html.twig", 42)->display(twig_to_array(["olivero_path" => ($context["olivero_path"] ?? null)]));
        // line 43
        echo "    ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["noscript_styles"] ?? null), 43, $this->source), "html", null, true);
        echo "
  </head>
  <body";
        // line 45
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["body_classes"] ?? null)], "method", false, false, true, 45), 45, $this->source), "html", null, true);
        echo ">
    ";
        // line 50
...
";
    ...
    {
        return array (  97 => 56,  93 => 55,  89 => 54,  85 => 53,  80 => 51,  77 => 50,  73 => 45,  67 => 43,  65 => 42,  61 => 41,  57 => 40,  53 => 39,  48 => 37,  45 => 36,  43 => 33,  42 => 32,  41 => 31,  40 => 30,  39 => 29,);
    }
    ...
    {
        static $tags = array("set" => 29, "include" => 42);
        static $filters = array("clean_class" => 31, "escape" => 37, "safe_join" => 40, "t" => 51);
